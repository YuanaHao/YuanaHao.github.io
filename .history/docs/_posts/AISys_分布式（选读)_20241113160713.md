...
拆分后如下图，$f$和$\overline{f}$替换为 g g g 和 g ‾ \overline{g} g​， g g g 和 g ‾ \overline{g} g​ 也是共轭的， g g g 在前向是all-gather通信，反向是reduce-scatter通信； g ‾ \overline{g} g​在前向是reduce-scatter, 反向是all-gather通信。
